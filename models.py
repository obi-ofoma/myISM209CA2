...
class User(db.Model):  #notice that our class extends db.Model
 __tablename__= 'register-user'#this is the name we want the table in database to have.
 ...
 NationalIdentificationNumber = db.Column(db.String(100), unique=False, nullable=False)
